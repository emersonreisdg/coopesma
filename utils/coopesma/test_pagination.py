...
from utils.coopesma.pagination import make_pagination_range
...
class PaginationTest(TestCase):
    ...
    def test_make_pagination_range_is_first_range_is_static_if_current_page_is_less_than_middle_page(self):  # noqa: E501
