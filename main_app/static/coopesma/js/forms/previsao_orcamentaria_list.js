    ...
    function renderTableBody(data) {
        ...
        data.forEach((item, index) => {
            ...
            Object.entries(item).forEach(([key, value]) => {
                ...
                } else if ((key === 'valor_liquido') && value) {
            ...
            if (index === 0) { // Apenas para a primeira linha (mais recente)
                ...
                editIcon.href = `/formulario/previsao_orcamentaria/editar/`;
                editIcon.classList.add("edit-icon");
                editIcon.textContent = "🖉"; // Ícone de edição

                const deleteIcon = document.createElement("a");
                deleteIcon.href = `/formulario/previsao_orcamentaria/delete/${item.id}`;
                ...
                confirmIcon.addEventListener("click", function (event) {
                    ...
                    if (confirmation) {
                        ...
                        fetch("/formulario/previsao_orcamentaria/confirmar/", {
                            method: "POST",
                            headers: {
                ...
                editIcon.addEventListener("click", function (event) {
                    ...
                    window.location.href = "/formulario/previsao_orcamentaria/editar/";
                });
